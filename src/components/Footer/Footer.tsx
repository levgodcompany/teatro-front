    ...
    <div className={styles.contacts}>
      ...
      <ul className={styles.contacts_local}>
        <li className={styles.contacts_local_item}>
          <a href="https://www.facebook.com/teatrobar.eljuvenil/" target="_blank" rel="noopener noreferrer">
            Facebook
          </a>
        </li>
        <li className={styles.contacts_local_item}>
          <a href="https://www.instagram.com/teatroeljuvenil/" target="_blank" rel="noopener noreferrer">
            Instagram
          </a>
        </li>
        <li className={styles.contacts_local_item}>
          <a href="mailto:info@eljuvenil.com">
            Email
          </a>
        </li>
        <li className={styles.contacts_local_item}>
